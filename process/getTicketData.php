...
if($pengunjung_id == 0) {
    echo "<script>alert('Session error. Please login again.'); window.location.href = 'process/logout.php';</script>";
    exit();
}
...
if(!$result_query || mysqli_num_rows($result_query) == 0) {
    echo "<script>alert('User not found.'); window.location.href = 'process/logout.php';</script>";
    exit();
}
        ...
        <section style="padding: 60px 0;">
            <div class="container">
                <div class="section-header">
                    <h2>My BTS Concert Tickets</h2>
                    <p>All your purchased tickets in one place</p>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 40px;">
                    ...
                    <div style="background: var(--bts-dark-tertiary); padding: 25px; border-radius: 15px; text-align: center; border: 2px solid rgba(138, 43, 226, 0.3);">
                        ...
                        <p style="color: var(--text-muted);">Total Spending</p>
                    </div>
                </div>
                ...
                if ($ticket_count > 0) {
                        ...
                        <div class="ticket-card">
                            ...
                            <div class="ticket-card-body">
                                ...
                                <div style="text-align: center; margin-bottom: 20px;">
                                    <p style="color: var(--text-muted); font-size: 0.9rem;"><i class="icon icon-calendar"></i> Purchased on '.$formatted_date.'</p>
                                </div>
                    ...
                    <div style="text-align: center; padding: 100px 20px; background: var(--bts-dark-tertiary); border-radius: 20px; border: 2px dashed rgba(138, 43, 226, 0.3);">
                        ...
                        <h3 style="color: var(--text-light); margin-bottom: 15px; font-size: 2rem;">No Tickets Found</h3>
                        <p style="color: var(--text-muted); margin-bottom: 40px;">
                            You haven\'t purchased any tickets yet. Get your BTS concert tickets now!
                        </p>
                        <a href="dashboard.php#buy-tickets" class="btn" style="padding: 15px 40px; font-size: 1.1rem;"><i class="icon icon-shopping-cart"></i> Buy Tickets Now</a>
                    </div>';
                }
                ?>
            </div>
    ...
    <div class="modal" id="ticketPreviewModal">
        <div class="modal-content" style="max-width: 900px;">
            <div class="modal-header">
                <h3><i class="icon icon-ticket"></i> 💜 BTS Ticket Preview</h3>
